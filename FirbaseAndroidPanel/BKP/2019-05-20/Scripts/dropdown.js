        ...
        $scope.update = function () {
         ...
         //   alert('i m 1');
            $http.post(raw + 'DropDownAndList/CatAndSubCat', data).then(function (response) {
                ...
                else if (response.data.length > 0 && $scope.pName !== 'sb') {
                    $scope.CatList = response.data;
                    $scope.catshow = true;

                } else if ($scope.pName === 'stk' || $scope.pName === 'sb' ) {
                    $scope.subdateshow = true;
                }
        ...
        $scope.Save = function() {
            ...
            if ($scope.pName === 'song') {
                ...
                $scope.finals = datat[0];
                    ...
                    $scope.finals.ServiceName = $scope.fireporalId;
            ...
            else if ($scope.fireporalId === 'undefined' ||
                pushtext === '' ||
                pushtext === 'undefined' ||
                a === 'undefined' ||
                a === '' ||
                pushtextTitle === '' ||
                pushtextTitle === 'undefined') {
                ...
                if ($scope.ListOfContentShow) {
                    ...
                    $http.post(raw + 'TokenManage/SavePushMessage', $scope.final).then(function(response) {
                        ...
                        if (response.data.result === 'Failed') {
                            window.location.href = "http://wap.shabox.mobi/fbandroid/";
                        } else {
                            window.location.href = "http://wap.shabox.mobi/fbandroid/ReportModify";
